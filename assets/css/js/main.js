	...
	jQuery(document).on('ready', function () {
		...
		$(window).on('scroll',function() {
            if ($(this).scrollTop() > 120){
				...
				$('.dropdown-menu.wrapper').addClass("is-sticky");
            }
            else{
                $('.navbar-area').removeClass("is-sticky");
				$('.dropdown-menu.wrapper').removeClass("is-sticky");
            }
        });
        ...
        $(".home-slides").on("translate.owl.carousel", function(){
            ...
            $(".main-banner-content h1 , .main-banner-content h2").removeClass("animated fadeInUp").css("opacity", "0");
        ...
        $(".home-slides").on("translated.owl.carousel", function(){
            ...
            $(".main-banner-content h1 , .main-banner-content h2").addClass("animated fadeInUp").css("opacity", "1");
